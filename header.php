	...
	<header id="masthead" class="site-header" role="banner">
		<div class="top-bar container">
			<div class="navbar-header">
				<button
					...
					<?php if ( totomo_is_amp() ) : ?>
						on="tap:site-navigation.toggleClass( class='collapse' ), site-navigation.toggleClass( class='in' ), navbar-toggle.toggleClass( class='mobile-menu-open' )"
					<?php endif; ?>
		...
		<div id="header-search" class="header-search right">
			<a
				...
				<?php if ( totomo_is_amp() ) : ?>
					on="tap:header-search.toggleClass( class='active-search' )"
				<?php endif; ?>
